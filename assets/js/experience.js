...
const exp = [
  ...
  },
   {
    ...
    desp: "<li> Spearheaded Kubernetes MP costing to enable cost analysis across namespaces, nodes, and clusters, driving cost-optimization decisions. </li> <li> Launched Server Tagging feature for on-demand pricing, improving cost estimation accuracy and reducing errors by 30%. </li> <li> Implemented Reference-Based and Reclamation Costing for VMC on Dell, resulting in reduction of infrastructure costs.</li>",
  },
   {
